      ...
      <div className="flex flex-1 flex-col items-center justify-center">
        <div className="flex flex-col gap-6 md:gap-[30px]">
          <div className="flex flex-col gap-1">
            <div className="flex items-end gap-2 md:gap-[7px]">
              <p className="font-semibold  text-[28px] md:text-[32px] lg:text-[40px]">점심</p>
              <p className="text-xs md:text-sm text-[#9C9C9C] mb-2">745.8kcal</p>
            </div>
